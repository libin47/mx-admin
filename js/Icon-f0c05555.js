...
`,[y("color-transition",{transition:"color .3s var(--n-bezier)"}),y("depth",{color:"var(--n-color)"},[F("svg",{opacity:"var(--n-opacity)",transition:"opacity .3s var(--n-bezier)"})]),F("svg",{height:"1em",width:"1em"})]);const gt=Object.assign(Object.assign({},A.props),{depth:[String,Number],size:[Number,String],color:String,component:Object}),zt=G({_n_icon__:!0,name:"Icon",inheritAttrs:!1,props:gt,setup(t){const{mergedClsPrefixRef:n,inlineThemeDisabled:r}=se(t),s=A("Icon","-icon",vt,ot,t,n),o=g(()=>{const{depth:c}=t,{common:{cubicBezierEaseInOut:u},self:x}=s.value;if(c!==void 0){const{color:b,[`opacity${c}Depth`]:d}=x;return{"--n-bezier":u,"--n-color":b,"--n-opacity":d}}return{"--n-bezier":u,"--n-color":"","--n-opacity":""}}),l=r?de("icon",g(()=>`${t.depth||"d"}`),o,t):void 0;return{mergedClsPrefix:n,mergedStyle:g(()=>{const{size:c,color:u}=t;return{fontSize:lt(c),color:u}}),cssVars:r?void 0:o,themeClass:l?.themeClass,onRender:l?.onRender}},render(){var t;const{$parent:n,depth:r,mergedClsPrefix:s,component:o,onRender:l,themeClass:c}=this;return!((t=n?.$options)===null||t===void 0)&&t._n_icon__&&it("icon","don't wrap `n-icon` inside `n-icon`"),l?.(),i("i",rt(this.$attrs,{role:"img",class:[`${s}-icon`,c,{[`${s}-icon--depth`]:r,[`${s}-icon--color-transition`]:r!==void 0}],style:[this.cssVars,this.mergedStyle]}),o?i(o):this.$slots)}});export{zt as N,Ct as a};

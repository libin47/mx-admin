import{a4 as a,af as d,a6 as o,ag as e,a5 as s,f,V as b,bv as p,a8 as g,cu as m,am as h,$}from"./index-d12868e1.js";const t="0!important",u="-1px!important";function i(r){return e(r+"-type",[o("& +",[a("button",{},[e(r+"-type",[s("border",{borderLeftWidth:t}),s("state-border",{left:u})])])])])}function n(r){return e(r+"-type",[o("& +",[a("button",[e(r+"-type",[s("border",{borderTopWidth:t}),s("state-border",{top:u})])])])])}var v=a("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
